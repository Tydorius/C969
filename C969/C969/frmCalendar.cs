    ...
    public partial class frmCalendar : Form
    {
        ...
        private void loadAppointments()
        {
            ...
            if (aptCount != 0)
            {
                ...
                {
                    // Add our row.
                    dtblAppointments.Rows.Add(tmpApt.appointmentId, tmpApt.title, tmpApt.type, tmpApt.url, tmpApt.start.ToString("MM-dd-yyyy hh:mm tt"), tmpApt.end.ToString("MM-dd-yyyy hh:mm tt"));
                }
            }
