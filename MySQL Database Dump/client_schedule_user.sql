...
INSERT INTO `user` (`userId`, `userName`, `password`, `active`, `createDate`, `createdBy`, `lastUpdate`, `lastUpdateBy`) VALUES (1,'test','test',1,'2019-01-01 00:00:00','test','2019-01-01 00:00:00','test');
